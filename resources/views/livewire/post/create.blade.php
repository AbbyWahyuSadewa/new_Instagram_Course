<div class="bg-white lg:h-[500px] flex flex-col border gap-y-4 px-5">
    ...
    <main class="grid grid-cols-12 gap-3 h-full w-full overflow-hideden">
        <aside class="lg:col-span-7 m-auto items-center w-full overflow-scroll">
            ...
            <div class="{{-- flex --}} hidden overflow-x-scroll w-[500px] h-96 snap-x snap-mandatory gap-2 px-2">
                <div class="w-full h-full shrink-0snap-always snap-center">
                    <x-video />
                </div>
                <div class="w-full h-full shrink-0snap-always snap-center">
        ...
        <aside class="lg:col-span-5 h-full brder-l p-3 flex gap-4 flex-col overflow-hidden overfow-scroll">
            ...
            <div>
                <textarea name="" id="" cols="30" rows="10" placeholder="Add a caption"
